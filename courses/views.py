...
class CourseModuleEditView(TemplateResponseMixin, View):
...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    ...
    def get_model(self, model_name):
        type_content = ['text', 'video', 'image', 'file']
        if model_name in type_content:
...
class CourseDetailView(DetailView):
    ...
    template_name = 'courses/subject/detail.html'
            #we include the form in the template context
